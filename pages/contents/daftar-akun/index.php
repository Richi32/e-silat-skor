            ...
            <div class="box-body">
                <table class="table table-condensed table-bordered table-hover" id="data-table">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $query_akun = mysqli_query($koneksi, 'SELECT * FROM users');
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge bg-green"><?= $data_akun['role'] ?></span>
                                </td>
                                <!-- <td class="text-center">
                                    <a href="<?= base_url() ?>process/daftar-akun/reset.php?id=<?= $data_akun['id_detail_kelas'] ?>" class="btn btn-sm btn-default"><i class="fa fa-refresh"></i></a>
                                </td> -->
                            </tr>
                        <?php } ?>
                    </tbody>
